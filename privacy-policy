...
Questions? Contact us at **privacy@ambigram.app**.
...
| **User Content** | Ambigram designs, imported images, background picks, feedback | Core service; sharing/downloading |
...
1. **Provide & maintain the App** (create ambigrams, render previews).  
...
Ambigram is **not directed to children under 13**.  
...
To exercise any right, use **Settings → Privacy & Data** in-app or e-mail **privacy@ambigram.app**.  
...
_or_ e-mail **privacy@ambigram.app** and we’ll guide you through verification.
